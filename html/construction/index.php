			...
			<div data-role="main" class="ui-content">
				<div class="container-container">
					<div class="main-content is-active" >
						...
						<div class="construction jorrellS-row" style="padding: 50px 0;" >
							<div class="jorrellS-col">
                                <div class="construction-container" style="display:flex;justify-content:center;flex-direction: column;padding: 0 20vw;">
                                    <div class="construction-heading" style="text-align: center">
                                        <h2>Under Construction</h2>
                                    </div>
                                    <div class="construction-subheading" style="text-align: center">
                                        <h5>This page is currently under construction</h5>
                                    </div>
                                    <div class="construction-image" style="display:flex;justify-content:center; padding-top: 50px;">
                                        <img style="width: 30%; height: auto;" src="/images/under-construction-sign.jpg" />
                                    </div>
                                </div>
                            </div>
						</div>
