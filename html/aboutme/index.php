						...
						<div class="my-stats carousel-slide-layout">
							<div class="carousel-slide-row row">
								<div class="col carousel-slide-col-4">
									<div class="carousel-slide-block html-block carousel-block-html">
										<div class="carousel-slide-block-content">
												...
												<div class="stat-subheading"><span>Hi, Im Jorrell Smith, a web developer from Panama City, FL. I have over 10 years of experience working with web servers, web applications, and websites. I create highly functional interfaces with simplicity, elegance, and innovation for each individual. I have an Associate of Science Degree in Software and Database Management and a Bachelor’s of Science in Technology Management. Currently, I work as an IT Manager where I oversee all IT functions within the organization. Visit my portfolio to find some samples of the different work I’ve been involved in.</span></div>
								...
								<div class="col carousel-slide-col-4">
									<div class="carousel-slide-block html-block carousel-block-html">
											<div class="carousel-slide-block-content">
													<div class="stat-heading"><span>Education</span></div>
													<div><h3>Gulf Coast State College</h3></div>
													<div class="stat-subheading"><span>B.S. - Technology Management</span></div>
													<div class="stat-subheading"><span>2023 (Graduate)</span></div><br><br>
													<div><h3>Gulf Coast State College</h3></div>
													<div class="stat-subheading"><span>A.S. - Software and Database Dev</span></div>
													<div class="stat-subheading"><span>2021 (Graduate)</span></div>
								...
								<div class="col carousel-slide-col-4">
									<div class="carousel-slide-block html-block carousel-block-html">
										<div class="carousel-slide-block-content">
											...
											<div class="stat-subheading"><span>Python, Java, Javascript, Bash, Powershell.</span></div>
											<div class="stat-subheading"><span>MySQL, Dynamo DB, Postgres.</span></div>
											<div class="stat-subheading"><span>Debian, Ubuntu, Windows Server.</span></div>
											<div class="stat-subheading"><span>Docker, Kubernetes, EKS</span></div>
											<div class="stat-subheading"><span>Terraform, Ansible, Cloud Formation</span></div>
											<div><h4>Soft Skills</h4></div>
											<div class="stat-subheading"><span>Customer Service</span></div>
											<div class="stat-subheading"><span>Working well with others</span></div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="my-mission carousel-slide-layout">
							<div class="carousel-slide-row row">
								<div class="col carousel-slide-col-3">
									<div class="carousel-slide-block html-block carousel-block-html">
										<div class="carousel-slide-block-content">
											<div class="stat-heading"><span>Contact Me</span></div>
										</div>
									</div>
								</div>
								...
								<div class="col carousel-slide-col-9">
									<div class="carousel-slide-block html-block carousel-block-html">
										<div class="carousel-slide-block-content">
											<div><h4>Email</h4></div>
											<div class="stat-subheading"><span>sabatiel180@gmail.com</span></div>
										</div>
									</div>
								</div>
							</div>
