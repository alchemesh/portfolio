...
<body>
                                        ...
                                        <div class="jorrellS-row">
                                                <div class="jorrellS-col">
                                                        <div style="text-align:center;padding:1.5vh 1.5%;height:7vh;position:relative:z-index:1;overflow-x:auto;">
                                                                ...
                                                                <div style="display:inline-block;padding: 0% 2%;"><a href="/mywork/" class="mywork"><span style="font-size:9px;font-weight:600;color:#222;">My Work</span></a></div>
				...
				<div class="container-container">
					<div class="main-content is-active" >
						...
						<div class="account-wrapper jorrellS-row">
                                        		...
                                        		<div class="account-navigation jorrellS-col large-3 xlarge-2">
							...
							<div class="account-content jorrellS-col large-9 xlarge-10 jorrellS-relative-position z-index-1" id="accountContent">

                                                															
								<div class="directContact">
									<div class="jorrellS-row">
										<div class="jorrellS-col small-6">
	 <h4>REGULAR MAIL</h4>
											<div class="contactinfo">
		<div class="businessname">	
			<span>Jorrell Smith</span>
		</div>
		<div class="businessaddress">
			<div><span>2003 North East Avenue Suite C <br> Panama City, FL 32405</span></div>
		</div>
 ...
 <div class="jorrellS-col small-6">
									...
									<div class="jorrellS-row">
										<div class="jorrellS-col medium-6 xlarge-3">		
	<div class="businessphone">
		<h5>Phone:</h5>
                <span>(850)960-1166</span>
	</div>
 </div>
 ...
 <div class="jorrellS-col medium-6 xlarge-3">
	<div class="businessemail">
		<h5>Email:</h5>
		<span>jsmith@<span>jorrellsmith.com</span></span>
	</div>
</div>
									</div>
