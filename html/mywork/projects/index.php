<?php
	...
	//include("../../scripts/server/websites.php");
...
<body>
										...
										<div class="carousel-slide-col-12 col">
											<div class="carousel-slide-block html-block carousel-block-html">
												<div class="carousel-slide-block-content">
													<div class="carousel-slide-block-content-inner"><span>Knowledge Is Freedom</span></div>
												</div>
											</div>
				...
				<div class="container-container">
					<div class="main-content is-active" >
						...
						<div class="account-wrapper jorrellS-row">
										...
										<li><a href="/mywork/websites" class="active" title="Websites">Websites</a></li>
										<li><a href="/mywork/webdev" class="active" title="Websites">Web Development</a></li>
										<li><a href="/mywork/projects" title="Websites">Projects</a></li>
						...
						<div class="template-selector light" >
                                                                                ...
                                                                                <div class="grid-menu">
                                                                                        <div>
                                                                                                <div class="template-grid-copy device-grid-copy">
                                                                                                        <div class="template-grid-heading"><span>View misc projects</span></div>
                                                                                                        <div class="template-grid-subheading"><span>Some miscellaneous projects ive developed over the years.</span></div>
                                                                                                </div>
    ...
    <span>Filter By</span>
                                                                                                                        <a class=""><span>All</span></a>

    <a class=""><span>Business</span></a>

    <a class=""><span>Portfolios</span></a>
